 ...
 */
final class Version20210711113913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `account` (`id` INT AUTO_INCREMENT NOT NULL, `bank_id` INT DEFAULT NULL, `name` VARCHAR(255) NOT NULL, `account_holder` VARCHAR(255) DEFAULT NULL, `bank_code` VARCHAR(64) DEFAULT NULL, `account_number` VARCHAR(64) DEFAULT NULL, `bic` VARCHAR(11) DEFAULT NULL, `iban` VARCHAR(34) DEFAULT NULL, `opening_balance` INT DEFAULT NULL, `created_at` DATETIME DEFAULT NULL, `updated_at` DATETIME DEFAULT NULL, `contact_id` INT DEFAULT NULL, INDEX IDX_7D3656A441327D4B (`bank_id`), UNIQUE INDEX UNIQ_7D3656A4315E9CF5 (`contact_id`), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `budget` (`id` INT AUTO_INCREMENT NOT NULL, `category_id` INT DEFAULT NULL, `name` VARCHAR(255) NOT NULL, `description` VARCHAR(1000) DEFAULT NULL, `amount` INT NOT NULL, `start_date` DATE DEFAULT NULL, `end_date` DATE DEFAULT NULL, `created_at` DATETIME DEFAULT NULL, `updated_at` DATETIME DEFAULT NULL, INDEX IDX_73F2F77B12469DE2 (category_id), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `category` (`id` INT AUTO_INCREMENT NOT NULL, `parent_id` INT DEFAULT NULL, `name` VARCHAR(255) NOT NULL, `description` VARCHAR(1000) NOT NULL, `created_at` DATETIME DEFAULT NULL, `updated_at` DATETIME DEFAULT NULL, INDEX IDX_64C19C1171ECA81 (`parent_id`), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `contact` (`id` INT AUTO_INCREMENT NOT NULL, `account_id` INT DEFAULT NULL, `name` VARCHAR(255) NOT NULL, `description` VARCHAR(1000) DEFAULT NULL, `created_at` DATETIME DEFAULT NULL, `updated_at` DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_4C62E6388C9FA493 (`account_id`), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `entry` (`id` INT AUTO_INCREMENT NOT NULL, `parent_id` INT DEFAULT NULL, `account_id` INT DEFAULT NULL, `contact_id` INT DEFAULT NULL, `category_id` INT DEFAULT NULL, `date` DATE NOT NULL, `amount` INT NOT NULL, `description` VARCHAR(1000) DEFAULT NULL, `created_at` DATETIME DEFAULT NULL, `updated_at` DATETIME DEFAULT NULL, INDEX IDX_2B219D70171ECA81 (`parent_id`), INDEX IDX_2B219D708C9FA493 (`account_id`), INDEX IDX_2B219D70315E9CF5 (`contact_id`), INDEX IDX_2B219D70ABF411AF (`category_id`), PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
